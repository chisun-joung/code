...
class TestChangeBatchQuantity:
    ...
    def test_reallocates_if_necessary(self):
        ...
        event_history = [
            ...
            events.BatchCreated("batch2", "ADORABLE-SETTEE", 50, date.today()),
            events.AllocationRequired("order1", "ADORABLE-SETTEE", 20),
            events.AllocationRequired("order2", "ADORABLE-SETTEE", 20),
        ]
        ...
        # order1 or order2 will be deallocated, so we'll have 25 - 20 = 5
        # available, and 20 will be allocated to order2
